...
import com.shopnolive.shopnolive.FamousLiveApp;
import com.shopnolive.shopnolive.utils.agora.WindowUtil;
...
public abstract class BaseActivity extends AppCompatActivity implements EventHandler {
    ...
    protected FamousLiveApp application() {
        return (FamousLiveApp) getApplication();
    }
