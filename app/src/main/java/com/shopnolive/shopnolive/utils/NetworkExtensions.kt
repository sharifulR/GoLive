...
import com.shopnolive.shopnolive.BuildConfig
import com.shopnolive.shopnolive.FamousLiveApp.Companion.getAppInstance
import com.shopnolive.shopnolive.R
import com.shopnolive.shopnolive.api.client.RetrofitClientFactory
...
fun getRestApis(): ApiService {
    return RetrofitClientFactory().getRetroFitClient().create(ApiService::class.java)
}
